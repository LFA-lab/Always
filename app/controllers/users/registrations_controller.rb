class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def configure_sign_up_params
    devise_parameter_sanitizer.permit(:sign_up, keys: [:first_name, :last_name, :service, :enterprise_id, :role, enterprise_attributes: [:name, :address, :phone]])
  end
  ...
  def enterprise_params
    params.require(:user).require(:enterprise_attributes).permit(:name, :address, :phone)
  end
end 