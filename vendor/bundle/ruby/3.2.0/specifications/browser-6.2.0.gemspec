...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/fnando/browser/blob/main/CHANGELOG.md", "funding_uri" => "https://github.com/sponsors/fnando", "rubygems_mfa_required" => "true" } if s.respond_to? :metadata=
